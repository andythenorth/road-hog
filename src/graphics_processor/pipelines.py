...
class PassThroughPipeline(Pipeline):
    ...
    def render(self, variant, consist, global_constants):
        ...
        input_path = os.path.join(currentdir, 'src', 'graphics', graphics_constants.vehicles_input_dir, consist.roster_id, options['template'])
...
class ExtendSpriterowsForCompositedCargosPipeline(Pipeline):
    ...
    def render(self, variant, consist, global_constants):
        ...
        self.input_path = os.path.join(currentdir, 'src', 'graphics', graphics_constants.vehicles_input_dir, consist.roster_id, self.options['template'])
